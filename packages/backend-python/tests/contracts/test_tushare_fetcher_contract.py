...
from tests.contracts import run_data_source_contract_tests
...
class TestTushareFetcherContract:
    ...
    @pytest.mark.asyncio
    async def test_tushare_fetcher_conforms_to_contract(self, tushare_fetcher):
        """
        ...
        assert run_data_source_contract_tests(tushare_fetcher), "TushareFetcher不符合DataSourceInterface契约"

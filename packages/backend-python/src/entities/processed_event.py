...
from quant_navigator_shared_types.events import ProcessedEvent, EventType, EventStatus
...
class ProcessedEventEntity(BaseEntity):
    ...
    # 关联信息
    related_stocks_json = Column(JSON, nullable=False, default=list, comment="相关股票代码列表")

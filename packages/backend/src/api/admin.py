...
@admin_router.get("/arbitration-cases/{case_id}", response_model=ArbitrationCaseResponse)
...
@admin_router.put("/arbitration-cases/{case_id}", response_model=ArbitrationCaseResponse)

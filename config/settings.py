...
class Settings:
    ...
    def __init__(self):
        ...
        # 数据库配置
        self.DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://user:password@localhost:5432/quantitative_navigator")
        ...
        self.MACRO_RISK_CALCULATION_ENABLED = os.getenv("MACRO_RISK_CALCULATION_ENABLED", "true").lower() == "true"
        self.STYLE_ROTATION_CALCULATION_ENABLED = os.getenv("STYLE_ROTATION_CALCULATION_ENABLED", "true").lower() == "true"
        
        # 异常检测配置
        self.ANOMALY_DETECTION_ENABLED = os.getenv("ANOMALY_DETECTION_ENABLED", "true").lower() == "true"
        self.ANOMALY_THRESHOLD = float(os.getenv("ANOMALY_THRESHOLD", "2.5"))
        self.ANOMALY_DETECTION_INTERVAL = int(os.getenv("ANOMALY_DETECTION_INTERVAL", "300000"))
        
        # 仲裁配置
        self.AUTO_ARBITRATION_THRESHOLD = float(os.getenv("AUTO_ARBITRATION_THRESHOLD", "0.8"))
        self.HUMAN_REVIEW_REQUIRED = os.getenv("HUMAN_REVIEW_REQUIRED", "true").lower() == "true"

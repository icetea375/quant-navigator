      ...
      <el-tab-pane label="基础配置" name="basic">
        <el-form :model="basicConfig" label-width="120px">
          ...
          <el-form-item label="最大并发数">
            <el-input-number v-model="basicConfig.maxConcurrency" :min="1" :max="100" />
          </el-form-item>
      ...
      <el-tab-pane label="AI配置" name="ai">
        <el-form :model="aiConfig" label-width="120px">
          ...
          <el-form-item label="置信度阈值">
            <el-slider v-model="aiConfig.confidenceThreshold" :min="0" :max="1" :step="0.1" />
            <span class="slider-value">{{ aiConfig.confidenceThreshold }}</span>
          </el-form-item>
          <el-form-item label="最大Token数">
            <el-input-number v-model="aiConfig.maxTokens" :min="1000" :max="10000" />
          </el-form-item>
      ...
      <el-tab-pane label="数据库配置" name="database">
        <el-form :model="dbConfig" label-width="120px">
          ...
          <el-form-item label="连接池大小">
            <el-input-number v-model="dbConfig.poolSize" :min="1" :max="100" />
          </el-form-item>
        </el-form>
      </el-tab-pane>
      ...
      <el-tab-pane label="监控配置" name="monitoring">
        <el-form :model="monitoringConfig" label-width="120px">
          ...
          <el-form-item label="CPU阈值">
            <el-slider v-model="monitoringConfig.cpuThreshold" :min="0" :max="100" />
            <span class="slider-value">{{ monitoringConfig.cpuThreshold }}%</span>
          </el-form-item>
          <el-form-item label="内存阈值">
            <el-slider v-model="monitoringConfig.memoryThreshold" :min="0" :max="100" />
            <span class="slider-value">{{ monitoringConfig.memoryThreshold }}%</span>
          </el-form-item>
          <el-form-item label="磁盘阈值">
            <el-slider v-model="monitoringConfig.diskThreshold" :min="0" :max="100" />

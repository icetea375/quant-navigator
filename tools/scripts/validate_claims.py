...
class ClaimsValidator:
    ...
    def __init__(self, project_root: str):
        ...
        self.performance_db = self.project_root / "data" / "performance" / "performance.db"
    ...
    def generate_validation_report(self, validated_claims: List[Dict]) -> str:
        ...
        report.append(f"- 支撑率: {supported_claims/total_claims*100:.1f}%" if total_claims > 0 else "- 支撑率: 0%")
        report.append("")

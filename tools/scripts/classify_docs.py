...
class DocsClassifier:
    ...
    def __init__(self, project_root: str):
        ...
        self.classification_rules = {
            "to_be_adr": [
                "架构设计", "技术选型", "设计决策", "ADR", "架构模式",
                "为什么选择", "技术方案", "系统设计", "模块化", "微服务"
            ],
            "to_be_guides": [
                "开发流程", "操作指南", "设置指南", "部署指南", "测试指南",
                "如何", "步骤", "流程", "规范", "标准", "配置指南"
            ],
            "to_be_docstring_or_code_comment": [
                "算法", "实现", "代码", "函数", "类", "方法", "业务逻辑",
                "计算", "处理", "分析", "检测", "生成"
            ],
            "to_be_archived": [
                "报告", "完成报告", "状态报告", "更新报告", "整理报告",
                "legacy", "历史", "归档", "旧版", "v13.8", "Sprint"
            ]
        }
    ...
    def classify_all_documents(self):
        ...
        # 分类所有文档
        classified_count = {category: 0 for category in self.classification_rules.keys()}
        
        for file_path in self.docs_dir.glob("*.md"):
            if file_path.name in ["测试宪法.md", "ADR.md", "docstring规范.md", "知识传承框架.md", "文档质量门禁配置.md", "配置统一指南.md"]:
                # 这些是新宪法的核心文档，跳过分类
                continue

...
def create_test_arbitration_cases():
    ...
    stock_codes = ['000001', '000002', '000858', '002415', '300059', '600036', '600519', '000858']
    ...
    for i in range(20):  # 创建20个测试案件
        ...
        case = {
            ...
            "status": random.choice(['PENDING_HUMAN', 'PENDING_HUMAN', 'PENDING_HUMAN', 'IGNORED']),  # 大部分是待处理
            "analysis_metadata": {
...
def main():
    ...
    # 保存为JSON文件
    with open('/Users/pengcheng/Documents/papa/database/test_data/arbitration_cases_test_data.json', 'w', encoding='utf-8') as f:
    ...
    with open('/Users/pengcheng/Documents/papa/database/test_data/arbitration_cases_test_data.sql', 'w', encoding='utf-8') as f:
        f.write("-- 测试仲裁案件数据\n")

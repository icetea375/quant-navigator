...
from attribution.rule_engine import AttributionRuleEngine
from monitoring.attribution_monitor import AttributionMonitor, AttributionMetrics
...
class AttributionEngineTester:
    ...
    def test_engine_initialization(self):
        ...
        try:
            ...
            if self.rule_engine is not None:
                assert hasattr(self.rule_engine, 'rules_config'), "规则引擎应包含配置"
                assert hasattr(self.rule_engine, 'stats'), "规则引擎应包含统计信息"
    ...
    def test_rule_engine(self):
        ...
        try:
            ...
            # 执行规则检查
            attribution_result = self.rule_engine.execute_attribution_rules(test_event_data)
            ...
            self.log_test_result("规则引擎", True, f"处理了{stats['total_processed']}个事件")
            return True
    ...
    def test_attribution_monitor(self):
        ...
        try:
            ...
            assert recent_metrics is not None, "应能获取最近指标"
            
            # 测试性能仪表盘
            performance_dashboard = self.attribution_monitor.get_performance_dashboard(days=7)
            assert performance_dashboard is not None, "应能获取性能仪表盘"
    ...
    def test_database_integration(self):
        ...
        try:
            ...
            assert result is not None, "应能查询数据库"
    ...
    def test_attribution_analysis(self):
        ...
        try:
            ...
            for stock in test_stocks:
                ...
                # 执行规则引擎分析
                if self.rule_engine:
                    attribution_result = self.rule_engine.execute_attribution_rules(event_data)
                    if attribution_result:
                        logger.info(f"股票 {stock['ts_code']} 归因结果: {attribution_result['attribution_label']}")
            
            self.log_test_result("归因分析", True, f"分析了{len(test_stocks)}个股票事件")
            return True
    ...
    def test_performance_metrics(self):
        ...
        try:
            ...
            assert monitor_stats is not None, "应能获取监控统计"

...
from schemas.arbitration import AnalysisResult
from services.meta_cognition_engine import MetaCognitionEngine, MetaCognitionResult
...
class TestMetaCognitionIntegration:
    ...
    @pytest.mark.asyncio
    async def test_green_phase_meta_cognition_with_consistent_reports(

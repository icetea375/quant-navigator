...
from schemas.arbitration import AnalysisResult, SentimentAnalysis
from services.llm_providers.qwen_provider import QwenProvider
...
class TestLLMGatewayIOIntegration:
    ...
    @pytest.mark.asyncio
    async def test_green_phase_should_handle_valid_json_response(

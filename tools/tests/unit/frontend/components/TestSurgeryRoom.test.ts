...
import { createTestWrapper, createTestWrapperWithRoute, cleanupTestEnvironment } from '../../../utils/createTestWrapperSimple'
...
describe('无菌手术室验证', () => {
  ...
  describe('路由功能', () => {
    it('应该能够使用路由', () => {
      const wrapper = createTestWrapperWithRoute(TestComponent, '/test')

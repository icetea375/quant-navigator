...
class ReportService:
    ...
    async def get_reports(
        ...
        return {"data": paginated_reports, "total": total}
    ...
    async def get_reports_by_target_code(
    ...
    async def get_statistics(self) -> Dict[str, Any]:
        ...
        for report in self.reports.values():
            if report.target_code:
                target_code_counts[report.target_code] = (
                    target_code_counts.get(report.target_code, 0) + 1
                )
        ...
        return {
            ...
            "latest_report_date": max(
                [report.created_at for report in self.reports.values()], default=None
            ),
        }

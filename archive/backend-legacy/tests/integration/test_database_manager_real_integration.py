...
class TestDatabaseManagerRealIntegration:
    ...
    def test_get_mda_data_should_create_table_and_insert_data(
        self, db_manager, sample_stock_code, sample_trade_date
    ):
        """
        ...
        assert (
            result["stock_code"] == sample_stock_code
        ), f"股票代码应该匹配: {sample_stock_code}"
    ...
    def test_get_mda_data_should_return_none_when_no_data_exists(
        self, db_manager, sample_stock_code, sample_trade_date
    ):
        """
    ...
    def test_get_mda_data_should_handle_database_errors_gracefully(
        self, db_manager, sample_stock_code, sample_trade_date
    ):
        """
        ...
        assert (
            "数据库" in result["error"] or "连接" in result["error"]
        ), "应该包含数据库相关错误信息"

    def test_get_mda_data_should_query_correct_table_and_columns(
        self, db_manager, sample_stock_code, sample_trade_date
    ):
        """

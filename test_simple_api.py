        ...
        "data": [
            {
                ...
                "human_decision": arbitration_result.get("human_decision") if arbitration_result else None,
                "human_reasoning": arbitration_result.get("final_recommendation") if arbitration_result else None
            }
        ],
        "total": 1,
        "page": 1,
    ...
    if case_id == "ARB_000001_20250925":
        return {
            ...
            "data": {
                ...
                "human_decision": arbitration_result.get("human_decision") if arbitration_result else None,
                "final_recommendation": arbitration_result.get("final_recommendation") if arbitration_result else None,
                "final_confidence": arbitration_result.get("final_confidence") if arbitration_result else None,
                "human_arbitrator_id": arbitration_result.get("arbitrator_id") if arbitration_result else None,
                "qwen_analysis": {
                    "analysis": "基于财务数据分析，该股票基本面表现稳定：营收增长15%，利润率维持在35%以上，现金流为正。建议持有观望。",
                    "confidence": 0.85,
                    "reasoning": "基本面稳定，建议持有",

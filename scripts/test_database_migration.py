...
class DatabaseMigrationTester:
    ...
    def test_arbitration_cases_table(self) -> bool:
        ...
        try:
            ...
            with self.db_manager.get_session() as session:
                ...
                # 验证必需字段
                required_columns = {
                    'id', 'case_id', 'stock_code', 'trade_date', 'qwen_report_id', 'doubao_report_id',
                    'divergence_score', 'sentiment_diff', 'keyword_overlap', 'entity_diff',
                    'consensus_summary', 'conflict_summary', 'priority_score', 'company_importance',
                    'event_importance', 'status', 'created_at', 'updated_at'
                }
                ...
                # 验证必需索引
                required_indexes = {'idx_case_id', 'idx_stock_date', 'idx_status', 'idx_priority_score'}
    ...
    def test_generated_reports_modifications(self) -> bool:
        ...
        try:
            ...
            with self.db_manager.get_session() as session:
                ...
                required_columns = {'source', 'sentiment_score', 'keywords', 'entities', 'summary'}
                actual_columns = {col[0] for col in columns}
                missing_columns = required_columns - actual_columns
    ...
    def test_arbitration_analysis_stats_table(self) -> bool:
        ...
        try:
            ...
            with self.db_manager.get_session() as session:
                ...
                required_columns = {
                    'id', 'trade_date', 'total_cases', 'pending_cases', 'completed_cases',
                    'ignored_cases', 'avg_divergence_score', 'avg_priority_score',
                    'high_priority_cases', 'medium_priority_cases', 'low_priority_cases'
                }
            ...
            self.logger.error(f"测试arbitration_analysis_stats表失败: {e}", exc_info=True)
            return False
    ...
    def test_views(self) -> bool:
        ...
        try:
            ...
            with self.db_manager.get_session() as session:
                # 检查视图是否存在
                views_to_check = ['v_high_priority_cases', 'v_arbitration_cases_overview']
    ...
    def run_all_tests(self) -> bool:
        ...
        tests = [
            ...
            ("arbitration_analysis_stats表", self.test_arbitration_analysis_stats_table),

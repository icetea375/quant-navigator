...
# ==============================================================================
# Production Startup Script for High-Performance Quant Navigator
# ==============================================================================
# This script starts both the web server and background worker processes
# for the modernized architecture using Granian + Arq.
# ==============================================================================
...
echo -e "${BLUE}🚀 Starting Quant Navigator Production Environment${NC}"
echo -e "${BLUE}================================================${NC}"
...
echo -e "   Web Server:  http://$WEB_HOST:$WEB_PORT"
echo -e "   Worker:      Background processing (PID: $WORKER_PID)"
echo -e "   Redis:       $REDIS_HOST:$REDIS_PORT"
echo -e ""
echo -e "${BLUE}📝 Logs:${NC}"
echo -e "   Web Server:  tail -f $LOG_DIR/web.log"
